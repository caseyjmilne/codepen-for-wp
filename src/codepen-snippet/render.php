...
if ( ! function_exists( 'cpfwp_render_snippet_block' ) ) {
	/**
	 * Renders the block markup. Wrapped in a function (guarded against
	 * redeclaration) rather than left at file scope, since this template is
	 * require()'d once per block instance on the page — plain top-level
	 * variables here would otherwise be treated as globals.
	 *
	 * @param array $attributes Block attributes.
	 */
	function cpfwp_render_snippet_block( $attributes ) {
...
cpfwp_render_snippet_block( $attributes );
