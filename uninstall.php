...
if ( ! function_exists( 'cpfwp_uninstall_site' ) ) {
	/**
...
if ( ! function_exists( 'cpfwp_uninstall' ) ) {
	/**
	 * Dispatches the per-site cleanup across every site on a multisite
	 * network, or just the current site otherwise.
	 */
	function cpfwp_uninstall() {
		if ( is_multisite() ) {
